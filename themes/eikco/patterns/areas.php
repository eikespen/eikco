<?php
/**
 * Title: Areas — photo collections
 * Slug: eikco/areas
 * Categories: eikco
 * Description: Three big photo cards with area names overlaid, matching the Cottage Properties "collections" layout.
 * Keywords: areas, neighborhoods, collections, photos
 */
?>
<!-- wp:group {"tagName":"section","align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60","left":"var:preset|spacing|40","right":"var:preset|spacing|40"},"blockGap":"var:preset|spacing|50"}},"layout":{"type":"constrained"}} -->
<section class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--40)">
	...
	<div class="wp-block-group">
		...
		<h2 class="wp-block-heading has-text-align-center has-serif-font-family" style="font-size:clamp(1.625rem, 2vw + 1rem, 2.375rem);font-weight:400;letter-spacing:-0.005em;line-height:1.2">A few neighbourhoods, known well</h2>
		<!-- /wp:heading -->

		<!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"1.0625rem","lineHeight":"1.7"}}} -->
		<p class="has-text-align-center" style="font-size:1.0625rem;line-height:1.7">Rather than pretending to cover the entire Costa Blanca, I focus on a handful of areas where I actually live and work — and where I know the streets, the neighbours, the builders, and the prices actually paid.</p>
		<!-- /wp:paragraph -->

	</div>
	<!-- /wp:group -->

	<!-- wp:columns {"align":"wide","style":{"spacing":{"blockGap":{"left":"var:preset|spacing|30","top":"var:preset|spacing|30"},"margin":{"top":"var:preset|spacing|50"}}}} -->
	<div class="wp-block-columns alignwide" style="margin-top:var(--wp--preset--spacing--50)">
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-cover" style="border-radius:2px;min-height:440px"><span aria-hidden="true" class="wp-block-cover__background has-ink-background-color has-background-dim-30 has-background-dim"></span><img class="wp-block-cover__image-background" alt="Ciudad Quesada" src="https://picsum.photos/seed/eikco-quesada/1200/900" data-object-fit="cover"/><div class="wp-block-cover__inner-container">
				...
				<h3 class="wp-block-heading has-text-align-center has-text-color has-serif-font-family" style="color:#ffffff;font-style:italic;font-size:2rem;font-weight:400;letter-spacing:0">Ciudad Quesada</h3>
				<!-- /wp:heading -->
			</div></div>
			<!-- /wp:cover -->
		</div>
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-cover" style="border-radius:2px;min-height:440px"><span aria-hidden="true" class="wp-block-cover__background has-ink-background-color has-background-dim-30 has-background-dim"></span><img class="wp-block-cover__image-background" alt="La Fiesta" src="https://picsum.photos/seed/eikco-fiesta/1200/900" data-object-fit="cover"/><div class="wp-block-cover__inner-container">
				...
				<!-- /wp:paragraph -->
				<!-- wp:heading {"textAlign":"center","level":3,"style":{"typography":{"fontSize":"2rem","fontWeight":"400","fontStyle":"italic","letterSpacing":"0"},"color":{"text":"#ffffff"}},"fontFamily":"serif"} -->
				<h3 class="wp-block-heading has-text-align-center has-text-color has-serif-font-family" style="color:#ffffff;font-style:italic;font-size:2rem;font-weight:400;letter-spacing:0">La Fiesta</h3>
				<!-- /wp:heading -->
			</div></div>
			<!-- /wp:cover -->
		</div>
